 ...
 * @author wongtiksoon
 */
@WebServlet(name = "SalesmanEditCar", urlPatterns = {"/SalesmanEditCar"})
public class SalesmanEditCar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if (found.getStatus().equals("Cancel")){
                ...
                if(e instanceof NumberFormatException){
                    ...
                    String message = "Please enter brand with no letters!";
                    request.setAttribute("message", message);
                }
